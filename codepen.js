...
// browsers control
const $browsers = $fragment.appendChild(document.createElement('input')); $browsers.className = 'option-browsers'; $browsers.value = 'last 2 chrome versions, last 2 edge versions, last 2 firefox versions, last 2 safari versions, last 3 ios versions, last 2 android versions';
